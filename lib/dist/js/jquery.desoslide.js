        ...
        _overlay: function () {
            ...
            if (this.options.overlay !== 'none') {
                ...
                if ($(this.elem).find('.'+ this._namespace +'-overlay').length === 0) {
                    ...
                    }).prependTo($(this.elem).find('.'+ this._namespace +'-wrapper'));
                }
        ...
        */
        _controls: function () {
            ...
            if (this.props.img.$overlay.find('a:first').length > 0) {
              $controls.prependTo(this.props.img.$overlay.find('a:first'));
            } else {
                $controls.prependTo(this.props.img.$overlay.parent('div'));
            }
