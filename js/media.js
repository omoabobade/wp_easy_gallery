...
jQuery(document).ready(function($){
    ...
    $(document.body).on('click.tgmOpenMediaManager', '.tgm-open-media', function(e){
        ...
        tgm_media_frame.on('select', function(){
            ...
            var media_attachments = tgm_media_frame.state().get('selection').toJSON();
            var html_val = '<table class="widefat fixed" cellspacing="0">\n\
                                <thead>\n\
                                    <tr> \n\
                                ...
                                <tbody>';
            var tr_inner = '';
           for (var key in media_attachments) {
                if (media_attachments.hasOwnProperty(key)) {
                     tr_inner  += '<tr class="alternate">\n\
                                                <th class="check-column" scope="row"><input id="cb-select-2" type="checkbox" name="post[]" value="'+(key)+'"></th>\n\
                                                <td class="column-columnname">'+media_attachments[key].title+'</td> \n\
                                                <td class="column-columnname"><img src="'+media_attachments[key].url+'" width="300" /></td>\n\
                                                <td class="manage-column column-columnname num"><a href="#">click to remove</a><input type="hidden"  name="image_id[]" value="'+media_attachments[key].id+'"/></td>\n\
                                        </tr>';
            ...
            if ( $( "#is_edit" ).length ) {
                ...
                html_val = html_val + tr_inner;
            }
             html_val  += '</tbody>       <tfoot>\n\
                                    <tr> \n\
                                        <th id="cb" class="manage-column column-cb check-column" scope="col"><input id="cb-select-2" type="checkbox" ></th>\n\
                                        <th id="columnname" class="manage-column column-columnname" scope="col">Title</th>\n\
                                        <th id="columnname" class="manage-column column-columnname" scope="col">Image</th>\n\
